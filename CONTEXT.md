...
- sw.js — единый service worker (push + network-first), CACHE='yaya-v61'.
...
- sw.js: CACHE='yaya-v61' (в CANON встречаются устаревшие 'yaya-v28'/'yaya-v44' — код говорит v61), API_HOST='yaya-db-production.up.railway.app' — данные API никогда не кэшируются; network-first с кэш-фолбэком. После правки любого html — бампить версию кэша в sw.js.
